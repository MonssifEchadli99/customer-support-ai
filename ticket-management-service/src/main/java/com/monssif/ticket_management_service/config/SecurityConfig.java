    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/lookup/**").authenticated()
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/comments/**").hasAnyRole("AGENT", "ADMIN")
                        .requestMatchers("/tickets/assignments/**").hasAnyRole("AGENT", "ADMIN")
                        .requestMatchers("/tickets/workflow/**").hasAnyRole("AGENT", "ADMIN")
